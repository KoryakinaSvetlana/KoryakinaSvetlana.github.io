...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		...
		var jsSlider = (0, _slider.slider)();
		jsSlider.init({
			track: '#slider-track',
			thump: '#slider-thumb',
			result: '#js-master-level'
		});
		var textarea = (0, _autosize.autosize)();
		textarea.init('.about__story-place');
	});
...
/***/ (function(module, exports) {
	...
	var slider = exports.slider = function slider() {
		...
		var init = function init(options) {
			options = options || {};
			var sliderTrack = document.querySelector(options.track);
			if (!sliderTrack) {
				return;
			}
			var sliderThumb = sliderTrack.querySelector(options.thump);
			if (!sliderThumb) {
				return;
			}
			var result = document.querySelector(options.result);
			if (!result) {
				return;
			}
	
			var sliderClientCoords = sliderTrack.getBoundingClientRect();
			var sliderCoords = {};
			...
			sliderThumb.onmousedown = function (e) {
				...
				var itemClientCoords = sliderThumb.getBoundingClientRect();
				var itemCoords = {};
	
				itemCoords.top = itemClientCoords.top + pageYOffset;
				itemCoords.left = itemClientCoords.left + pageXOffset;
	
				var right = sliderTrack.offsetWidth - sliderThumb.offsetWidth;
				...
				document.onmousemove = function (evt) {
					...
					result.value = Math.round(newLeft / right * 100) + '%';
					return false;
				};
...
/***/ (function(module, exports) {
	...
	var autosize = exports.autosize = function autosize() {
		var elem = {};
		var init = function init(selector) {
			...
			for (var i = 0; i < textarea.classList.length; i++) {
				hiddenDiv.classList.add(textarea.classList[i]);
			}
			...
			cnt = cnt.replace(/\n/g, '<br>');
			hiddenDiv.innerHTML = cnt + '<br class="lbr">';
			...
			textarea.onkeyup = function (e) {
				...
				if (hiddenDiv.clientHeight > 200) {
					e.target.style.height = hiddenDiv.clientHeight + 'px';
				} else {
